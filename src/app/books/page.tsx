                ...
                {books.length === 0 ? (
                    <div className="text-center py-12">
                         <div className="flex justify-center flex-col items-center">
                            <svg className="w-[120px] h-[120px] text-blue-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#1c398e" viewBox="0 0 24 24">
                        ...
                        <Link
                            href="/books/add"
                            className="bg-blue-900 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-medium inline-block transition"
                        >
                            + Add Your First Book
                        </Link>
                    </div>
