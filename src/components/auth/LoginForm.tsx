...
export default function LoginForm() {
    ...
    return (
        <form className="space-y-4 text-gray-900" onSubmit={handleSubmit}>
            ...
            <button
                disabled={loading}
                type="submit" className="cursor-pointer  disabled:bg-gray-400 disabled:cursor-not-allowed w-full bg-blue-900 hover:bg-blue-700 text-white p-2 rounded-lg font-semibold transition">
